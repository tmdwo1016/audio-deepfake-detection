...
> 이 문서는 22번 MERT unseen-generator·MP3 확장 이전에 작성된 보고서다. 최신 결과는 [`../SUMMARY.md`](../SUMMARY.md)와 [`22_mert_unseen_generator_report.md`](22_mert_unseen_generator_report.md)를 기준으로 한다.
...
- Detection: [`baseline`](../results/baseline/), [`cnn`](../results/cnn/), [`mert`](../results/mert/)
- Unseen generator: [세 모델 비교표](../results/mert_unseen_generator/mert_unseen_comparison.csv)
- Codec robustness: [세 모델 비교표](../results/mert_mp3_robustness/mert_mp3_track_comparison.csv)
- Generator attribution: [`generator_attribution`](../results/generator_attribution/)
- PCA/UMAP: [`generator_fingerprint_visualization`](../results/generator_fingerprint_visualization/)
- Genre/feature analysis: [`generator_genre_feature_analysis`](../results/generator_genre_feature_analysis/)
- 1차 통합 그림과 표: [`final_analysis`](../results/final_analysis/)

개별 예측값과 중복 실행 폴더는 제출본에서 제외했다. 최신 수치는 `summary/`와 위 비교표를 기준으로 하며, 표시값은 소수 넷째 자리에서 반올림했다.
